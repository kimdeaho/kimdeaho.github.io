...
%>	
	...
	<div class="content">
		<div class="breadcrumb">
			...
			<div class="bread">
				<p>
					<a href="p_allProduct.jsp">제품목록</a> <span> &gt;</span> <span>껌류</span>
				</p>
			</div>
		</div>
		<section class="con">
		...
		<section class="contentsBody">
			<div class="subContents">
				<div class="subTitleArea">
					<h3 style="color: red; font-size: 20px; font-weight:bold; text-align: left; margin-top: 15px;">껌류</h3>
					<div class="typeList">
