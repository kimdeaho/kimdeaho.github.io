...
<head>
<meta charset="UTF-8">
<title>신제품 코드 중복 체크</title>
</head>
<body>
	<div class="wrap">
		<h3 class="pop_tit">신제품 코드 중복 확인</h3>
		<form action="p_codeCheckPro2.jsp" method="post" onsubmit="return invalidCheck(this)">
			<div class="item_fr">	
				<label for="pcode" class="lb">제품 코드 : </label>
